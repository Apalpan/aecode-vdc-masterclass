...
function Framework() {
  return (
    <>
      ...
      <Pillars />
      <p className="nx-quote up" style={st(5)}>Kunz & Fischer (2020) definen el framework con <b>BIM + gestión por objetivos + producción Lean + ICE</b>, sobre el modelo organizacional VDT de Ray Levitt. En la práctica peruana, ese pilar de producción Lean se gestiona como <b>PPM</b> (Project Production Management). Puedes tener modelos espectaculares y cero VDC.</p>
    </>
  )
}
  ...
  return (
    <>
      ...
      <Stats items={[
        ...
        { v: '10', t: 'factores identificados por CIFE que reducen la latencia de respuesta entre disciplinas casi a cero', src: 'CIFE WP087 (2004) · Chachere, Kunz & Levitt', ac: 'v' },
      ]} />
...
function Ppm() {
  return (
    <>
      ...
      <p className="nx-quote up" style={st(5)}>Aquí VDC se abraza con el <b>Lean Construction</b> que ya vieron en el diplomado: el Last Planner System es el instrumento estrella del pilar PPM. En el congreso IGLC 2021 (Lima) se documentaron <b>405 interacciones VDC–Lean</b>, mayoritariamente positivas — más que las halladas entre Lean y BIM a solas.</p>
    </>
  )
}
...
export const m2: Entry[] = [
  ...
  },
  {
    ...
    note: 'Conecta con el módulo Lean del diplomado: WIP limitado, variabilidad como enemigo, pull con lookahead, trenes de trabajo. PPM es donde vive el Last Planner System dentro de VDC. Dato citable (con precisión): IGLC 2021 en Lima documentó 405 interacciones VDC-Lean, mayoritariamente positivas — no compiten, se refuerzan. Ojo: son 405 interacciones documentadas, no “405 positivas”.',
  },
  {
